<template>
  <div class="the-header">
    ...
    <ul class="navbar" ref="change">
      ...
      <!-- 搜索框右侧部分 loginMsg（登录、注册） -->
      <li v-show="!loginIn" :class="{active: item.name === activeName}" v-for="item in loginMsg" :key="item.type" @click="goPage(item.path, item.name)">
        {{item.name}}
      </li>
    </ul>
